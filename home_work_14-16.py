...
# import math
# def round_crossing_check(first_circle_coord_x, first_circle_coord_y, first_circle_radius, second_circle_coord_x, second_circle_coord_y, second_circle_radius):
#     distance_between_centrs = math.sqrt((abs(first_circle_coord_x - second_circle_coord_x))**2 + (abs(first_circle_coord_y - second_circle_coord_y))**2)
...
#     return distance_between_centrs
#
# x = round_crossing_check(5, -10, 11, 3, 2, 3)
